 ...
 * generated in the javacuriosities.schema package. 
...
public class ObjectFactory {
    ...
    private final static QName _UserRequest_QNAME = new QName("http://www.javacuriosities/schema", "userRequest");
    private final static QName _UserResponse_QNAME = new QName("http://www.javacuriosities/schema", "userResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: javacuriosities.schema
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://www.javacuriosities/schema", name = "userRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://www.javacuriosities/schema", name = "userResponse")
