...
import ar.com.javacurisioties.jaxws.bindings.HelloWorldSOAP12;
...
import ar.com.javacurisioties.jaxws.schema_validation.HelloWorldSchemaValidation;
...
public class Publisher {
    public static void main(String[] args) {
        ...
        // SOAP 1.2
        Endpoint.publish("http://127.0.0.1:9999/HelloWorldSOAP12", new HelloWorldSOAP12());

        // Schema Validation
        Endpoint.publish("http://127.0.0.1:19999/HelloWorldSchemaValidation", new HelloWorldSchemaValidation());
    }
}
