    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (isRunning) {
                ...
                System.out.println("Receiver 1 - Remote Port:" + packet.getPort());
                System.out.println("Receiver 1 - Remote Address:" + packet.getAddress());
                System.out.println("Receiver 1 - Remote Socket Address:" + packet.getSocketAddress());
            }
        } catch (IOException e) {
