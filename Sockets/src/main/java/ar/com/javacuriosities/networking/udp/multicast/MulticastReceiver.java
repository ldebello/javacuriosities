 ...
 * Al correr este ejemplo puede ser que obtengamos una exception del tipo "java.net.SocketException: Can't assign requested address",
 * esto nos indica que la dirección solicitada no puede ser asignada un posible motivo para eso es que NetworkInterface.getDefault esta
 * tomando una NIC incorrecta (En este caso seria una NIC solo de IPv6). Esto lo debemos solucionar usando -Djava.net.preferIPv4Stack=true.
 *
 */
